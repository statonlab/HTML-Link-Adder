			...
			<div class="col-md-4">
				<div class="card p-3 shadow-sm">
					...
					<div class="form-group">
						...
						<button class="btn btn-secondary" v-clipboard:copy="
...
&lt;/table&gt;</pre>
				...
				<div class="alert alert-info">
					Each link goes between &lt;tr&gt; or 'table row' tags, while all links go between one &lt;table&gt;
					and &lt;body&gt; tag. (should this helptext be moved to the top so that it's always visible when
					undergrads scroll back up to copy-paste?
				</div>
			</div>
		</div>
	</div>
