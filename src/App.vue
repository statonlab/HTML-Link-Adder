	...
	<div class="row">
		<div class="col-md-4 shadow p-3 mb-5 bg-white">
			...
			<div class="form-check ml-5">
				<input class="form-check-input" type="checkbox" value="internal_link" id="defaultCheck1" v-model="checked">
		...
		<div class="col-md-8 shadow box p-3 mb-5 bg-white ">
...
&lt;/table&gt;
		...
		<div class="form-group ml-5">
			<label>Each link goes between &lt;tr&gt; or 'table row' tags, while all links go between one &lt;table&gt; and &lt;body&gt; tag. (should this helptext be moved to the top so that it's always visible when undergrads scroll back up to copy-paste?</label>
		</div>
	</div>
</template>
